...
import ProductScreen from './DailRightssWaySrc/[RainBornscrnns]/ProductScreen';
...
const RainWaystckrotes = () => {
  ...
  const Route = ({ isFatch }) => {
    ...
    return (
      ...
      //initialRouteName="RainBornLoader"<Stack.Screen name="RainBornLoader" component={RainBornLoader} />
    >
